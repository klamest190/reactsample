...
export const ARTEN = {
  ...
  TypeScript: { text: 'TSX', klassen: 'bg-blue-600 text-white dark:bg-blue-500', sprache: 'react' },
  TS: { text: 'TS', klassen: 'bg-blue-600 text-white dark:bg-blue-500', sprache: 'ts' },
