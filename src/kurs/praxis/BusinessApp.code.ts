 ...
 *
 * Die Dateien liegen als normale .jsx/.js-Dateien unter ./businessApp/ und werden
 ...
 */
const quellen = import.meta.glob<string>('./businessApp/**/*.{js,jsx}', {
  query: '?raw',
  import: 'default',
  eager: true,
})
...
const beschreibungen: Beschreibung[] = [
  ...
  },
  {
    pfad: 'data.js',
    text: {
      de: 'Die Startdaten. In einer echten App kämen sie per fetch vom Server.',
      en: 'The start data. In a real app they would come from a server via fetch.',
    },
  ...
  },
  {
    pfad: 'format.js',
    text: {
      de: 'Hilfsfunktionen ganz ohne React - ein normales JavaScript-Modul mit export.',
      en: 'Helper functions without any React - a plain JavaScript module with export.',
    },
    kapitel: ['js-dom', 'js-funktionen'],
  },
  {
    pfad: 'hooks/useSort.js',
    text: {
  ...
  {
    pfad: 'components/StatusBadge.jsx',
    text: {
  ...
  {
    pfad: 'components/CustomerForm.jsx',
    text: {
...
export const codeBloecke = {
  ...
  `,
  anlegen: js`
    npm create vite@latest brightdesk -- --template react
    cd brightdesk
